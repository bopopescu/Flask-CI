...
class DBInstance(AWSObject):
    ...
    props = {
        ...
        'MainUsername': (str, False),
        'MainUserPassword': (str, False),
    ...
    def validate(self):
        ...
        if 'SourceDBInstanceIdentifier' in self.properties:
            ...
            invalid_replica_properties = (
                'BackupRetentionPeriod', 'DBName', 'MainUsername',
                'MainUserPassword', 'PreferredBackupWindow', 'MultiAZ',
        ...
        if ('DBSnapshotIdentifier' not in self.properties and
            ...
            ('MainUsername' not in self.properties or
             'MainUserPassword' not in self.properties) and \
                ('DBClusterIdentifier' not in self.properties):
            raise ValueError(
                r"Either (MainUsername and MainUserPassword) or"
